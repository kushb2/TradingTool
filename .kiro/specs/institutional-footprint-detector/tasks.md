# Tasks - Institutional Footprint Detector v2

## Task 1: Project Setup & Runnable Baseline
Create the v2 folder structure with a minimal working Streamlit app.
...
## Task 2: Price Data Service (yfinance)
Fetch OHLC data and display in dashboard.
...
## Task 3: NSE Delivery Data Service
...
## Task 4: Derived Metrics Calculation
Calculate all the ratios and moving averages.
...
## Task 5: 15-Day Display Table
Show last 15 days with proper formatting and highlighting.
...
## Task 6: Phase 1 - Alert Detection
Detect accumulation alert days.
...
## Task 7: Phase 2 - Pump & Dump Filter
Check if delivery spike is sustained.
...
## Task 8: Phase 3 - Confirmation Check
Validate cluster of accumulation days.
...
Generate BUY/SELL/HOLD/WATCH signals.
...
## Task 10: Signal Display & UI Polish
Show signals prominently with explanations.
...
## Task 11: Price Chart with Moving Averages
Add interactive price chart.
...
## Task 12: Multi-Stock Support
Allow analyzing multiple stocks at once.
...
## Task 13: Help Section
Add educational tooltips and help sidebar.
...
*Each task ends with a TEST step - run the server and verify with real stocks before moving to next task.*
